...
export default function Sidebar({ palette, active = 'home', onAction, muted, onMute }: SidebarProps) {
  return (
    <aside style={{
      ...
      <div style={{ marginBottom: 18 }}>
        <img src="/images/logo.png" alt="" style={{ width: 36, height: 30, objectFit: 'contain', opacity: .9 }} />
      </div>
...
function RailButton({ icon, label, palette, active, onClick, accent }: any) {
...
function RailIcon({ name, color }: { name: string; color: string }) {
  ...
  switch (name) {
    case 'user':   return <svg {...(common as any)}><circle cx="12" cy="8" r="4" /><path d="M4 21v-1a8 8 0 0 1 16 0v1" /></svg>;
    case 'wallet': return <svg {...(common as any)}><path d="M3 7a2 2 0 0 1 2-2h14v4H5a2 2 0 0 1-2-2Z" /><path d="M3 7v10a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-3" /><circle cx="17" cy="13" r="1.5" /><path d="M21 9v8h-5a3 3 0 1 1 0-6h5z" /></svg>;
    case 'home':   return <svg {...(common as any)}><path d="M3 11.5 12 4l9 7.5" /><path d="M5 10v10h14V10" /></svg>;
    case 'volume': return <svg {...(common as any)}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07" /></svg>;
    case 'volume-off': return <svg {...(common as any)}><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /><line x1="22" y1="9" x2="16" y2="15" /><line x1="16" y1="9" x2="22" y2="15" /></svg>;
    case 'exit':   return <svg {...(common as any)}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4" /><polyline points="16 17 21 12 16 7" /><line x1="21" y1="12" x2="9" y2="12" /></svg>;
    default: return null;
  }
}
