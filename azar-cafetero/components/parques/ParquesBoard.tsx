          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-[#0a1f0a] via-[#1a3a1a] to-[#0a1f0a] shadow-2xl">
              ...
              <div className="absolute inset-6 rounded-xl overflow-hidden">
                ...
                {/* Corners */}
                <div className="absolute top-0 left-0 w-1/4 h-1/4 bg-red-600/40" />
                <div className="absolute top-0 right-0 w-1/4 h-1/4 bg-blue-600/40" />
                <div className="absolute bottom-0 left-0 w-1/4 h-1/4 bg-yellow-500/40" />
                <div className="absolute bottom-0 right-0 w-1/4 h-1/4 bg-green-600/40" />
